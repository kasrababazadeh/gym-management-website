        ...
        <form action="{{route('update', $user->id)}}" method="post">
            ...
            <div class="col-lg-10 float-left text-center">
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" class="form-control @error('code-melli') is-invalid @enderror" name="code-melli" value="{{$user->getAttribute('code-melli')}}">
                    </div>
                </div>
                <br>
                <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" class="form-control @error('phone-number') is-invalid @enderror" name="phone-number" value="{{$user->getAttribute('phone-number')}}">
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="form-row mb-3">
                            <div class="form-check form-check-inline col">
                                ...
                                <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="اقا" <?php if ($user->gender=='اقا') echo  'checked'?>>
                            </div>
                            <div class="form-check form-check-inline col">
                                <label class="form-check-label text-light" for="inlineRadio2">مونث</label>
                                <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="خانم" <?php if ($user->gender=='خانم') echo  'checked'?>>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input type="text" class="form-control" name="telegram-code" value="{{$user->getAttribute('telegram-code')}}">
                    </div>
                </div>
                <br>
                <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <select class="form-select form-control" name="membership-period" aria-label="Default select">
                            <option <?php if ($user->getAttribute('membership-period')==null) echo  'selected'?>>بدون اشتراک</option>
                            <option value="1" <?php if ($user->getAttribute('membership-period')==1) echo  'selected'?>>یک ماهه</option>
                            <option value="2" <?php if ($user->getAttribute('membership-period')==2) echo  'selected'?>>دو ماهه</option>
                            <option value="3" <?php if ($user->getAttribute('membership-period')==3) echo  'selected'?>>سه ماهه</option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <select class="form-select form-control" name="status" aria-label="Default select">
                            <option value="1" <?php if ($user->status==1) echo  'selected'?>>همراه با تردمیل و دوچرخه</option>
                            <option value="0" <?php if ($user->status==0) echo  'selected'?>>بدون تردمیل و دوچرخه</option>
                        </select>
                    </div>
                    <label class="col-lg-1 col-form-label text-light">تاریخ شروع اشتراک :</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="membership-date" value="{{$user->getAttribute('membership-date')}}">
                    </div>
                </div>
                <br>
