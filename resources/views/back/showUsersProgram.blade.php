        ...
        <div class="col-lg-10 float-left text-right">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th class="col-1">شنبه</th>
                    <th class="col-1">یکشنبه</th>
                    <th class="col-1">دوشنبه</th>
                    <th class="col-1">سه شنبه</th>
                    <th class="col-1">چهارشنبه</th>
                    <th class="col-1">پنج شنبه</th>
                    <th class="col-1">حذف برنامه</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{route('saturday', ['user' => $user->id, 'day' => 'storeSaturday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('sunday', ['user' => $user->id, 'day' => 'storeSunday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('monday', ['user' => $user->id, 'day' => 'storeMonday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('tuesday', ['user' => $user->id, 'day' => 'storeTuesday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('wednesday', ['user' => $user->id, 'day' => 'storeWednesday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('thursday', ['user' => $user->id, 'day' => 'storeThursday'])}}">نوشتن برنامه</a></td>
                    <td><a href="{{route('editSaturday', 6)}}">ویرایش برنامه شنبه</a></td>
                    <td><a href="{{route('programDestroy', $user->id)}}" onclick="return confirm('آیتم مورد نظر حذف شود؟');">حذف برنامه</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
