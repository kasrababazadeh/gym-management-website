...
class ThursdayController extends Controller
{
    ...
    {
        //
        $program = Thursday::where('user-code-melli', auth()->user()->getAttribute('code-melli'))->first();
        if ($program != null){
            $pagetitle = 'برنامه ورزشی پنج شنبه';
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'user-code-melli' => 'unique:thursdays',
     ...
     *
     * @param  \App\Models\Thursday  $thursday
     * @return \Illuminate\Http\Response
     */
