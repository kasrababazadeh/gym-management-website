...
class TuesdayController extends Controller
{
    ...
    {
        //
        $program = Tuesday::where('user-code-melli', auth()->user()->getAttribute('code-melli'))->first();
        if ($program != null){
            $pagetitle = 'برنامه ورزشی سه شنبه';
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'user-code-melli' => 'unique:tuesdays',
     ...
     *
     * @param  \App\Models\Tuesday  $tuesday
     * @return \Illuminate\Http\Response
     */
