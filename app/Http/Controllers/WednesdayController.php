...
class WednesdayController extends Controller
{
    ...
    {
        //
        $program = Wednesday::where('user-code-melli', auth()->user()->getAttribute('code-melli'))->first();
        if ($program != null){
            $pagetitle = 'برنامه ورزشی چهارشنبه';
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            'user-code-melli' => 'unique:wednesdays',
     ...
     *
     * @param  \App\Models\Wednesday  $wednesday
     * @return \Illuminate\Http\Response
     */
